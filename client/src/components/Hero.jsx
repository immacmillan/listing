import { MapPin, Users, User, UserRound } from 'lucide-react'
 ...
 return (
   <section className="relative w-full h-[55vh] min-h-[380px] flex items-end">
     ...
     <div
       ...
       role="img"
       aria-label="Aerial view of The Malta Residence, Green Valley Ranch, Denver"
     />
     {/* Gradient overlay */}
         ...
         <div className="max-w-2xl w-full">
           ...
           <div className="flex flex-wrap items-center gap-1.5 mb-3">
             <div className="inline-flex items-center gap-1 bg-white/15 backdrop-blur-sm border border-white/25 rounded-full px-2 py-0.5">
               <MapPin size={11} className="text-teal-accent" aria-hidden="true" />
