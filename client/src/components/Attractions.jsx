...
const categories = [
 {
   ...
   items: [
     { emoji: '🍖', label: 'The Smokehouse at Green Valley Ranch', detail: '<5 min drive' },
     ...
     { emoji: '🍺', label: 'Green Valley Ranch Beer Garden', detail: '~5 min drive' },
     ...
     { emoji: '🎯', label: 'Super Target', detail: 'opening Dec 26' },
   ],
 },
 {
